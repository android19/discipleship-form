...
export default function Edit({ submission, coaches, errors }: Props) {
    const [members, setMembers] = useState<Member[]>(submission.members || []);
    const [interns, setInterns] = useState<Member[]>(submission.interns || []);
    const [discipleshipClasses, setDiscipleshipClasses] = useState<DiscipleshipClass>(
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4">
                <Form action={`/admin/submissions/${submission.id}`} method="patch">
                    {({ processing, hasErrors, wasSuccessful }) => (
                        <div className="space-y-6">
                            ...
                            <Card className="bg-red-600 text-white p-6">
                                ...
                                <p className="text-center mt-2">
                                    Administrative Edit - Discipleship Update Form
                                </p>
                            </Card>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            name="leader_name"
                                            required
                                            defaultValue={submission.leader_name}
                                        />
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            name="mobile_number"
                                            required
                                            defaultValue={submission.mobile_number}
                                        />
                                        <InputError message={errors.mobile_number} />
                                    </div>
                                    <div>
                                        <Label htmlFor="ministry_involvement">Ministry Involvement</Label>
                                        <Select name="ministry_involvement" defaultValue={submission.ministry_involvement}>
                                            <SelectTrigger>
                                                <SelectValue placeholder="Select your ministry involvement" />
                                            </SelectTrigger>
                                            <SelectContent>
                                    ...
                                    <div>
                                        ...
                                        <Select name="coach" defaultValue={submission.coach}>
                                            <SelectTrigger>
                                    ...
                                    <div>
                                        ...
                                        <Select name="services_attended" defaultValue={submission.services_attended}>
                                            <SelectTrigger>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            min="0"
                                            required
                                            defaultValue={submission.victory_groups_leading}
                                        />
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-4 mt-2">
                                            <label className="flex items-center">
                                                <input type="radio" name="victory_group_active" value="1" className="mr-2" defaultChecked={submission.victory_group_active} />
                                                Yes
                                            </label>
                                            <label className="flex items-center">
                                                <input type="radio" name="victory_group_active" value="0" className="mr-2" defaultChecked={!submission.victory_group_active} />
                                                No
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <Textarea
                                            ...
                                            defaultValue={submission.inactive_reason || ''}
                                        />
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            type="date"
                                            defaultValue={submission.last_victory_group_date || ''}
                                        />
                                            ...
                                            {['Students', 'Singles', 'Married', 'Mixed'].map((type) => (
                                                <div key={type} className="flex items-center space-x-2">
                                                    <Checkbox
                                                        ...
                                                        value={type}
                                                        defaultChecked={submission.victory_group_types?.includes(type)}
                                                    />
                                                    <Label htmlFor={`victory_group_type_${type}`} className="text-sm">
                                                        {type}
                                                    </Label>
                                                </div>
                                            ))}
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-4 mt-2">
                                            <label className="flex items-center">
                                                <input type="radio" name="intern_invite_status" value="yes" className="mr-2" defaultChecked={submission.intern_invite_status === 'yes'} />
                                                Yes
                                            </label>
                                            <label className="flex items-center">
                                                <input type="radio" name="intern_invite_status" value="no" className="mr-2" defaultChecked={submission.intern_invite_status === 'no'} />
                                                No
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <Label htmlFor="victory_group_schedule">Victory Group Schedule</Label>
                                        <Input
                                            id="victory_group_schedule"
                                            name="victory_group_schedule"
                                            placeholder="e.g., Sunday 7PM"
                                            defaultValue={submission.victory_group_schedule}
                                        />
                                    ...
                                    <div>
                                        <Label htmlFor="concerns">
                                            Any concerns, prayer requests, or things you'd like to share?
                                        </Label>
                                        <Textarea
                                            id="concerns"
                                            name="concerns"
                                            rows={3}
                                            defaultValue={submission.concerns || ''}
                                        />
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {[
                                        ...
                                        <div key={key} className="flex items-center space-x-2">
                                            <Checkbox
                                                checked={discipleshipClasses[key as keyof DiscipleshipClass]}
                                                onCheckedChange={(checked) => 
                                                    setDiscipleshipClasses({
                                                        ...discipleshipClasses,
                                            ...
                                            <tbody>
                                                {members.map((member, index) => (
                                                    <tr key={member.id}>
                                                        ...
                                                        {[
                                                            'victory_weekend', 'purple_book', 'church_community', 
                                                            'making_disciples', 'empowering_leaders'
                                                        ].map((field) => (
                                                            <td key={field} className="border border-gray-300 px-2 py-2 text-center">
                                                                <Checkbox
                                                                    checked={member[field as keyof Member] as boolean}
                                                                    onCheckedChange={(checked) => updateMember(member.id, field as keyof Member, checked)}
                                                                />
                                                            </td>
                                                        ))}
                                                        <td className="border border-gray-300 px-2 py-2">
                            ...
                            {/* Victory Group Interns Section - Reactive */}
                            <Card className="p-6">
