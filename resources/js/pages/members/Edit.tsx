...
export default function Edit({ member, victoryGroups }: Props) {
                        ...
                        <div className="space-y-6">
                            ...
                            <Card className="p-6">
                                ...
                                <div>
                                    ...
                                    <Select name="victory_group_id" defaultValue={member.victory_group_id?.toString() || ''}>
                                        <SelectTrigger>
                                            <SelectValue placeholder="Select Victory Group (optional)" />
                                        </SelectTrigger>
                                        <SelectContent>
                                            <SelectItem value="">No Victory Group</SelectItem>
