...
export default function Edit({ leader, coaches }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit ${leader.full_name} - Leader`} />
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4">
                <Form action={`/leaders/${leader.id}`} method="patch">
                        ...
                        <div className="space-y-6">
                            ...
                            <Card className="bg-purple-600 text-white p-6">
                                ...
                                <p className="text-center mt-2">
                                    Update {leader.full_name}'s Information
                                </p>
                            </Card>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <Input 
                                            id="middle_initial" 
                                            name="middle_initial"
                                            defaultValue={leader.middle_initial || ''}
                                            maxLength={1} 
                                        />
                                    ...
                                    <div>
                                        ...
                                        <Select name="sex" defaultValue={leader.sex} required>
                                            <SelectTrigger>
                                    ...
                                    <div>
                                        ...
                                        <Input 
                                            id="contact_number" 
                                            name="contact_number"
                                            defaultValue={leader.contact_number}
                                            required 
                                        />
                                    ...
                                    <div>
                                        ...
                                        <Select name="status" defaultValue={leader.status} required>
                                            <SelectTrigger>
                            ...
                            <Card className="p-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 mt-1">
                                        Coach assignment is optional and can be changed anytime.
                                    </p>
                                </div>
                            </Card>
                            ...
                            <Card className="p-6">
                                <div className="flex gap-4 justify-end">
                                    ...
                                    <Button type="submit" disabled={processing}>
                                        {processing ? 'Updating...' : 'Update Leader'}
                                    </Button>
                                </div>
                            </Card>
