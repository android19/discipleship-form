...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Create Victory Group',
        href: '/victory-groups/create',
    },
];
                            ...
                            <Card className="p-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 mt-1">
                                        Leader assignment is optional and can be changed later.
                                    </p>
                                </div>
                            </Card>
                            ...
                            <Card className="p-6">
                                <div className="flex gap-4 justify-end">
                                    ...
                                    <Button type="submit" disabled={processing}>
                                        {processing ? 'Creating...' : 'Create Victory Group'}
                                    </Button>
                                </div>
                            </Card>
                            ...
                            {wasSuccessful && (
                                <Card className="p-6 border-green-300 bg-green-50">
                                    <p className="text-green-600 font-medium">
                                        Victory Group created successfully!
                                    </p>
                                </Card>
                            )}
                        </div>
